...
class WalletConnectUtils extends WalletEvmUtil {
    ...
    try {
      ...
      switch (params.request.method) {
        ...
        case 'eth_signTypedData_v3':
          ...
          result = await WalletConnectUtils.signTypedData(raw, wallet?.privateKey)
          break
        case 'eth_signTransaction':
          result = await WalletConnectUtils.signTransaction(
            {
              ...msgParams,
              chainId,
            },
        ...
        case 'eth_sendTransaction':
          result = await WalletConnectUtils.sendTransaction(
            {
              ...msgParams,
              chainId,
            },
          ...
          break
        case 'personal_sign':
          const msg = await WalletConnectUtils.signMessage(
            {
              message: msgParams,
            },
            wallet?.privateKey
        ...
        case 'wallet_requestPermissions':
          result = await WalletConnectUtils.getPermissions()
          break
        case 'wallet_registerOnboarding':
          result = true
          break
        case 'wallet_watchAsset':
          result = await WalletConnectUtils.watchAsset(msgParams, chainId)
          break
        ...
        case 'wallet_sendCalls':
          result = await WalletConnectUtils.sendCalls(msgParams, wallet?.privateKey)
          break
        ...
        case 'wallet_getCapabilities':
          result = await WalletConnectUtils.getCapabilities(wallet.address)
          break
      }
